...
class Order(models.Model):
    ...
    telegram_number = models.CharField(max_length=50)
...
class OrderItem(models.Model):
    ...
    volume = models.ForeignKey(ProductVolume, on_delete=models.PROTECT)
    ...
    def __str__(self):
        return f"{self.product.name} ({self.volume.name}) x{self.quantity}"
